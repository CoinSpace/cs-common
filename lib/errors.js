...
export class MinimumReserveSourceError extends AmountError {
  name = 'MinimumReserveSourceError';
  constructor(amount, options) {
    super('Less than minimum reserve on source address', options);
    this.amount = amount;
  }
}
...
export class InsufficientCoinForTokenTransactionError extends AmountError {
  name = 'InsufficientCoinForTokenTransactionError';
  constructor(amount, options) {
    super('Insufficient funds for token transaction', options);
    this.amount = amount;
  }
}
